    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**നിങ്ങൾ ഞങ്ങളുടെ ചാനലിൽ ഇതുവരെ ജോയിൻ ചെയ്തിട്ടില്ല ജോയിൻ ചെയ്താൽ മാത്രമേ സിനിമകൾ കിട്ടുക. താഴെ കാണുന്ന ഞങ്ങളുടെ ചാനലിൽ ജോയിൻ ചെയ്തതിന് ശേഷം വീണ്ടും ശ്രമിക്കുക\n\n[ You Have Not Yet Joined Our Channel  Please Try Again After Joining ]**",
