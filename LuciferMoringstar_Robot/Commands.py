...
@Client.on_message(filters.command('information'))
async def bot_info(bot, message):
    ...
    await message.reply(text=f"{INFORMATION}", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
